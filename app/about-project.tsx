  ...
  return (
    <View style={styles.screen}>
      ...
      >
        ...
        <Text style={styles.supportTitle}>{t("about.ideasTitle")}</Text>
        ...
        >
          ...
          <Text style={styles.secondaryButtonText}>{t("about.writeIdea")}</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.secondaryButtonText}>{t("about.inviteOwn")}</Text>
        </TouchableOpacity>

        <Tekmet style={styles.tekmet} />

        <Text style={styles.supportTitle}>{t("about.supportTitle")}</Text>
        ...
        <View style={styles.qrCard}>
          ...
          <Text style={styles.qrHint}>{t("about.qrHint")}</Text>
        </View>
        ...
        >
          ...
          <Text style={styles.primaryButtonText}>{t("about.openLink")}</Text>
        </TouchableOpacity>
        ...
        <Text style={styles.footerNote}>{t("about.footer")}</Text>
      </ScrollView>
    </View>
  );
}
